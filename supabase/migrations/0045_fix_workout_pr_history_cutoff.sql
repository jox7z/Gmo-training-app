-- Corrige detección de PR al publicar workouts históricos.
-- El baseline solo puede incluir sesiones anteriores a la sesión publicada.
-- Reinstala el contrato completo de 0044 y hace deterministas los empates.
...
begin
  ...
  -- PRs conservan el contrato previo, ahora con baseline temporal correcto.
