-- Sincronización atómica del snapshot completo de un workout.
--
-- El cliente conserva una cola por workout para ordenar sus propios intentos.
-- Este RPC agrega serialización entre dispositivos y una única transacción para
-- parent + exercises + sets, evitando árboles parciales o intercalados.
