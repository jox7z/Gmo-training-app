-- 0013 Fix list_followers / list_following — return type change
--
-- 0011_follow_rank_points.sql usó CREATE OR REPLACE pero el tipo de
-- retorno cambió (se añadió rank_points). PostgreSQL exige DROP previo.
-- 0011 es inmutable; este archivo aplica el intent correcto.
--
-- Seguro de re-aplicar: DROP IF EXISTS + recreación completa.
